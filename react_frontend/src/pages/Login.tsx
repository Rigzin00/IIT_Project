    ...
    >
      ...
      <div className="w-full max-w-[460px] px-4">
        ...
        <div className="text-center mb-7">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl mb-4 bg-[#F7EEEE] border-[1.5px] border-[rgba(196,18,18,0.25)] shadow-[0_2px_8px_rgba(196,18,18,0.08)] hover:shadow-[0_4px_16px_rgba(196,18,18,0.18)] hover:scale-105 transition-all duration-300">
            <GraduationCap size={28} color="#C41212" />
          </div>
        ...
        >
          ...
          <div className="flex bg-[#F7EEEE] rounded-[10px] p-1 mb-6 gap-[3px] border border-[#E5E7EB]">
            {ROLES.map(r => (
              <button
                key={r.id}
                className={`flex-1 text-center py-2 px-1.5 rounded-[7px] text-[12.5px] font-semibold transition-all duration-300 leading-[1.4] tracking-[0.1px] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C41212] ${
                  role === r.id 
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              id="login-submit"
              className={`inline-flex items-center justify-center gap-2 w-full py-[11px] px-5 text-[14.5px] font-bold tracking-[0.3px] leading-none whitespace-nowrap rounded-lg border-2 select-none overflow-hidden transition-all duration-300 focus:outline-none focus-visible:shadow-[0_0_0_3px_#fff,0_0_0_5px_#C41212] ${
                loading 

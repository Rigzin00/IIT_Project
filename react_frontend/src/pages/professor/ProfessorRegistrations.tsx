                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontFamily: "'Open Sans',sans-serif", fontSize: 13, whiteSpace: 'nowrap' }}>
                  <thead>
                    <tr style={{ background: '#FAFAFA' }}>
                      ...
                      <th onClick={() => toggleSort('cgpa')} style={{ textAlign: 'left', padding: '10px 16px', fontSize: 10, fontWeight: 700, color: '#9CA3AF', textTransform: 'uppercase', cursor: 'pointer', borderBottom: '1px solid #E5E7EB' }}>CGPA <SortIcon k="cgpa" /></th>
